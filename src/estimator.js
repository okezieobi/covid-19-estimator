...
const calcInfectionsByRequestedTime = (
  ...
  if (periodType === 'weeks') return currentlyInfected * 256 * period;
  if (periodType === 'months') return currentlyInfected * 1024 * period;
  return Math.round(currentlyInfected * 34.13 * period);
};
